...
若不符可微调行间距。\par%
\noindent
参考资料：http://www.ankang.gov.cn/Content-2060365.html\par
\vfill
\special{color pop}
}
...
\vbox to 28pt{%
\special{color push rgb 0 0 1}%
\hsize = 46mm\hrule\songti\vfill 空一行\vfill\par\hrule
\special{color pop}
}
{
\fangsong
...
\vskip 1mm
\hrule
\vbox to 0pt{\songti \vskip 4pt 印章距正文 大于1毫米 且在一行之内}
\vskip 28pt
\hrule
\special{color pop}
}\kern 38mm
