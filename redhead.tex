...
\font\title="Noto Sans SC/OT:color=0000FF" at 9pt
\font\body="Source Han Serif SC:color=0000FF" at 8pt
\body
\XeTeXlinebreaklocale "zh"
\XeTeXlinebreakskip = 0pt plus 1pt minus 0.1pt

\font\songtifoot="[SimSun]:color=FFFFFF" at 14pt
\footline = {\vbox{%
...
若不符可微调行间距。\par%
\noindent
参考资料：http://openstd.samr.gov.cn/bzgk/gb/newGbInfo?hcno=F3CC9BEF482524C895FDA7A08BB4A70E\par
\vfill
\special{color pop}
}
...
\vbox to 28pt{%
\special{color push rgb 0 0 1}%
\hsize = 46mm\hrule\vfill 空一行\vfill\par\hrule
\special{color pop}
}
{
\fangsong
